...
describe('CanaryStatusIndicator Component', () => {
  ...
  test('renders loading state correctly', () => {
    ...
    expect(link).toHaveClass('statusLoading');
  ...
  test('renders error state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusError');
  ...
  test('renders missing data state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusError'); // Treat missing as error
   ...
   test('renders invalid date state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusError'); // Treat invalid date as error
  ...
  test('renders VALID state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusValid');
  ...
  test('renders UPDATE_DUE state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusWarning');
   ...
   test('renders EXPIRED state correctly', () => {
    ...
    const link = screen.getByRole('link');
    expect(link).toHaveClass('statusExpired');
   ...
   test('applies additional className prop', () => {
    const customClass = 'my-extra-class';
     ...
     const link = screen.getByRole('link');
     expect(link).toHaveClass('indicator'); // Module class
     expect(link).toHaveClass('statusLoading'); // Module class for state
     expect(link).toHaveClass(customClass); // Additional class
  });
